...
public class LocationService extends Service {
    ...
    private void startLocationService() {
        ...
        builder.setContentTitle("Driving Log");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            // 서비스가 비정상종료 되었음을 의미하고, 시스템이 자동으로 서비스를 재시작함
    ...
    // Service -> Activity로 LocationList를 전달하기 위한 브로드캐스트
    private void sendMessage(LocationResult locationResult){
        Log.d("messageService", "Broadcasting message");
        locationList = locationResult.getLocations();
        Intent intent = new Intent("latLngIntent");
        intent.putParcelableArrayListExtra("BroadcastLocationList", (ArrayList<? extends Parcelable>) locationList);
